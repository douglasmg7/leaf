...
selecting an entire line + cr
    ...
    ! function() {
        ...
        y.getUtils = p, y.prototype = {
            ...
            update: function() {
                ...
                for (var t = this.points, n = t.length, r = n - 1; n > 1; n--, r--) {
                    for (var i, e = [], o = 0; r > o; o++) i = {
                        x: r * (t[o + 1].x - t[o].x),
                        y: r * (t[o + 1].y - t[o].y)
                    }, this._3d && (i.z = r * (t[o + 1].z - t[o].z)), e.push(i);
            ...
            on: function(t, n) {
                n = n || 5;
                for (var r, i = this.getLUT(), e = [], o = 0, s = 0; s < i.length; s++) r = i[s], h.dist(r, t) < n && (e.push(r), o += s / i.length);
            ...
            project: function(t) {
                ...
                var a, s, f, c, x = (o - 1) / r,
                    y = (o + 1) / r,
                    p = .1 / r;
                for (e += 1, s = x, a = s; y + p > s; s += p) f = this.compute(s), c = h.dist(t, f), e > c && (e = c, a = s);
            ...
            compute: function(t) {
                ...
                if (1 === this.order) return f = {
                    x: r * n[0].x + t * n[1].x,
                    y: r * n[0].y + t * n[1].y
                }, this._3d && (f.z = r * n[0].z + t * n[1].z), f;
                if (this.order < 4) {
                    var i, e, o, s = r * r,
                        u = t * t,
                        a = 0;
            ...
            raise: function() {
                for (var t, n, r, i = this.points, e = [i[0]], o = i.length, t = 1; o > t; t++) n = i[t], r = i[t - 1], e[t] = {
                    x: (o - t) / o * n.x + t / o * r.x,
                    y: (o - t) / o * n.y + t / o * r.y
                };
            ...
            derivative: function(t) {
                var n, r, i = 1 - t,
                    e = 0,
                    o = this.dpoints[0];
                2 === this.order && (o = [o[0], o[1], c], n = i, r = t), 3 === this.order && (n = i * i, r = i * t * 2, e = t * t);
                var s = {
            ...
            hull: function(t) {
                ...
                for (e[o++] = r[0], e[o++] = r[1], e[o++] = r[2], 3 === this.order && (e[o++] = r[3]); r.length > 1;) {
                    for (i = [], s = 0, u = r.length - 1; u > s; s++) n = h.lerp(t, r[s], r[s + 1]), e[o++] = n, i.push(n);
                    r = i
                }
                return e
            },
            ...
            extrema: function() {
                ...
                return r.forEach(function(r) {
                    n = function(t) {
                        return t[r]
                    }, t = this.dpoints[0].map(n), i[r] = h.droots(t), 3 === this.order && (t = this.dpoints[1].map(n), i[r] = i[r].concat(h.droots(t))), i[r] = i[r].filter(function(t) {
                        return t >= 0 && 1 >= t
                    }), e = e.concat(i[r].sort())
                    ...
                    for (r = 0, i = 0; 1 >= i;)
                        for (i = r + o; 1 + o >= i; i += o)
                            if (n = t.split(r, i), !n.simple()) {
                                ...
                                n = t.split(r, i), n._t1 = h.map(r, 0, 1, t._t1, t._t2), n._t2 = h.map(i, 0, 1, t._t1, t._t2), u.push(n), r = i;
                                break
                            }
            ...
            outline: function(t, n, r, i) {
                ...
                s.forEach(function(o) {
                    _ = o.length(), p ? (a.push(o.scale(e(t, r, y, c, _))), f.push(o.scale(e(-n, -i, y, c, _)))) : (a.push(o.scale(t)), f.push(o.scale(-n))), c += _
                }), f = f.map(function(t) {
            ...
            p = {
                ...
                length: function(t) {
                    var n, r, i = .5,
                        e = 0,
                        o = p.Tvalues.length;
                    for (n = 0; o > n; n++) r = i * p.Tvalues[n] + i, e += p.Cvalues[n] * p.arcfn(r, t);
                    return i * e
                },
                ...
                angle: function(t, n, r) {
                    var i, e = n.x - t.x,
                        ...
                        h = u(e * e + o * o),
                        x = u(a * a + f * f);
                    return e /= h, o /= h, a /= x, f /= x, i = e * a + o * f, s(c, i)
                },
                round: function(t, n) {
                    var r = "" + t,
                        i = r.indexOf(".");
                ...
                getminmax: function(t, n, r) {
                    ...
                    var i, e, o = 0x10000000000000000,
                        s = -o; - 1 === r.indexOf(0) && (r = [0].concat(r)), -1 === r.indexOf(1) && r.push(1);
                ...
                roots: function(t, n) {
                    ...
                    if (0 > j) {
                        var C = -e / 3,
                            ...
                            J = f(U),
                            N = 2 * J;
                        return z = N * i(I / 3) - a / 3, b = N * i((I + h) / 3) - a / 3, _ = N * i((I + 2 * h) / 3) - a / 3, [z, b, _].filter(s)
                    }
                    if (0 === j) return g = 0 > T ? f(-T) : -f(T), z = 2 * g - a / 3, b = -g - a / 3, [z, b].filter(s);
                    var P = u(j);
                    return g = f(-T + P), d = f(T + P), [g - d - a / 3].filter(s)
                },
                droots: function(t) {
                    if (3 === t.length) {
                        var n = t[0],
                ...
                getccenter: function(t, n, r) {
                    var o, u = n.x - t.x,
                        ...
                        T = s(n.y - M.y, n.x - M.x),
                        j = s(r.y - M.y, r.x - M.x);
                    return j > O ? ((O > T || T > j) && (O += h), O > j && (o = j, j = O, O = o)) : T > j && O > T ? (o = j, j = O, O = o) : j += h, M.s = O, M.e = j, M.r = k, M
                }
            };
        t.exports = p
    }()
